...
class _AbstractHyperEstimator(HyperModel):
    ...
    def _events_embedding_block(self, hp, input_events, input_freq, input_dim,
                                tag, max_activities, max_dim=256):
        """Protected method generating a block specifically designed for
        ...
        fre_reshape = tf.reshape(
            input_freq,
            shape=[-1, max_activities, 1]
        )

        event_freq = Concatenate()(
            [event_reshape, fre_reshape]
        )
