...
for model_name, model_dict in encoders.items():
    ...
    save_full_model(model, path="results\\saved_trained_models\\{}")

    for out_layer in out_layers:

        encoder = model.get_encoder(out_layer=out_layer)
        encoder.save(f"results\\saved_encoders\\{model_name}_{out_layer}")
